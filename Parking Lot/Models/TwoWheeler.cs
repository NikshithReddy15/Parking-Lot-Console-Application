...
{
    internal class TwoWheeler : ParkingLot
    {
        ...
        public TwoWheeler(string vehicleNumber, string vehicleType, string ownerName, int slotID, int engineCapacity, int seatingCapacity, int fuelCapacity, int maxWeight)
        {
