...
{
    internal class HeavyVehicle : Vehicle
    {
        ...
        public HeavyVehicle(string vehicleNumber, string vehicleType, string ownerName, int slotID, int engineCapacity, int seatingCapacity, int fuelCapacity, int maxWeight) : base(vehicleNumber, vehicleType, ownerName, slotID)
        {
